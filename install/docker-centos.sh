...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/fxtaoo/cmd/master/install/docker-centos.sh)"
# bash -c "$(curl -fsSL https://proxy.fxtaoo.dev/cmd/install/docker-centos.sh)"
...
sudo curl -o /etc/docker/daemon.json https://proxy.fxtaoo.dev/cmd/conf/${docker_daemon}.json
