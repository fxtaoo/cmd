...
# bash -c "$(wget -qO - https://raw.fxtaoo.dev/fxtaoo/cmd/master/install/debian-docker.sh)"
...
curl -fsSL https://${normal_url}/linux/debian/gpg | gpg --dearmor -o /etc/apt/keyrings/docker.gpg
