...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/fxtaoo/cmd/master/other/docker-image-clean.sh)"
# bash -c "$(curl -fsSL https://proxy.fxtaoo.dev/cmd/other/docker-image-clean.sh)"
