#!/usr/bin/env bash
# 筛选删除容器
# bash -c "$(curl -fsSL https://raw.fxtaoo.dev/fxtaoo/cmd/master/other/docker-rm-grep-str.sh)"
# bash -c "$(wget -qO - https://raw.fxtaoo.dev/fxtaoo/cmd/master/other/docker-rm-grep-str.sh)"
